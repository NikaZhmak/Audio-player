...
let currentSong = function(song_name){
    songName.innerHTML = `${song_name}`;
     audio.src = `assets/audio/${song_name}.mp3`;
    cover.src = `assets/img/${song_name}.png`;
    background.innerHTML = `<img class="background" src="assets/img/${song_name}.png" alt="background">`
